...
mod part1 {
    ...
    #[parameterized]
    #[case(" ", NorthPoleError::InvalidInstruction(' '))] // a space
    #[case("()()() ()()", NorthPoleError::InvalidInstruction(' '))] // a space surround by valid tokens
    #[case("\t", NorthPoleError::InvalidInstruction('\t'))] // a tab
    #[case("()()()\0", NorthPoleError::InvalidInstruction('\0'))] // nul terminated string
    #[case("⬆", NorthPoleError::InvalidInstruction('⬆'))] // an up-pointing arrow
